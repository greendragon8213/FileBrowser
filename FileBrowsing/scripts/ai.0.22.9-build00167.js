    ...
    (function (ApplicationInsights) {
        ...
        var Util = (function () {
            ...
            Util.setCookie = function (name, value, domain) {
                ...
                Util.document.cookie = name + "=" + value + domainAttrib + ";FullPath=/";
            };
            ...
            Util.deleteCookie = function (name) {
                Util.document.cookie = name + "=;FullPath=/;expires=Thu, 01 Jan 1970 00:00:01 GMT;";
            };
...
/// <reference FullPath="../logging.ts" />
/// <reference FullPath="../util.ts" />
/// <reference FullPath="./ajaxUtils.ts" />
var Microsoft;
(function (Microsoft) {
    var ApplicationInsights;
    (function (ApplicationInsights) {
...
/// <reference FullPath="../util.ts" />
/// <reference FullPath="./ajaxUtils.ts" />
/// <reference FullPath="./ajaxRecord.ts" />
var Microsoft;
(function (Microsoft) {
    var ApplicationInsights;
    (function (ApplicationInsights) {
...
/// <reference FullPath="../../Contracts/Generated/Envelope.ts" />
/// <reference FullPath="../../Contracts/Generated/Base.ts" />
/// <reference FullPath="../../Util.ts"/>
...
/// <reference FullPath="./HashCodeScoreGenerator.ts" />
var Microsoft;
(function (Microsoft) {
    var ApplicationInsights;
    (function (ApplicationInsights) {
...
/// <reference FullPath="../SamplingScoreGenerator.ts" />
var Microsoft;
(function (Microsoft) {
    var ApplicationInsights;
    (function (ApplicationInsights) {
...
/// <reference FullPath="../util.ts" />
/// <reference FullPath="../Contracts/Generated/SessionState.ts"/>
var Microsoft;
(function (Microsoft) {
    var ApplicationInsights;
    (function (ApplicationInsights) {
...
/// <reference FullPath="serializer.ts" />
/// <reference FullPath="Telemetry/Common/Envelope.ts"/>
/// <reference FullPath="Telemetry/Common/Base.ts" />
/// <reference FullPath="Contracts/Generated/ContextTagKeys.ts"/>
/// <reference FullPath="Context/Application.ts"/>
/// <reference FullPath="Context/Device.ts"/>
/// <reference FullPath="Context/Internal.ts"/>
/// <reference FullPath="Context/Location.ts"/>
/// <reference FullPath="Context/Operation.ts"/>
/// <reference FullPath="Context/Sample.ts"/>
/// <reference FullPath="Context/Session.ts"/>
/// <reference FullPath="Context/User.ts"/>
/// <reference FullPath="ajax/ajax.ts"/>
/// <reference FullPath="./DataLossAnalyzer.ts"/>
;
var Microsoft;
(function (Microsoft) {
    var ApplicationInsights;
...
/// <reference FullPath="Domain.ts" />
/// <reference FullPath="SeverityLevel.ts" />
var AI;
(function (AI) {
    "use strict";
...
/// <reference FullPath="../Contracts/Generated/MessageData.ts" />
/// <reference FullPath="./Common/DataSanitizer.ts"/>
var Microsoft;
(function (Microsoft) {
    var ApplicationInsights;
    (function (ApplicationInsights) {
...
/// <reference FullPath="../Contracts/Generated/EventData.ts" />
/// <reference FullPath="./Common/DataSanitizer.ts"/>
var Microsoft;
(function (Microsoft) {
    var ApplicationInsights;
...
/// <reference FullPath="Domain.ts" />
/// <reference FullPath="SeverityLevel.ts" />
/// <reference FullPath="ExceptionDetails.ts"/>
var AI;
(function (AI) {
    "use strict";
...
/// <reference FullPath="../Contracts/Generated/ExceptionData.ts" />
/// <reference FullPath="../Contracts/Generated/StackFrame.ts" />
/// <reference FullPath="./Common/DataSanitizer.ts"/>
var Microsoft;
(function (Microsoft) {
    var ApplicationInsights;
...
/// <reference FullPath="DataPointType.ts" />
var AI;
(function (AI) {
    "use strict";
...
/// <reference FullPath="../../Contracts/Generated/DataPoint.ts"/>
var Microsoft;
(function (Microsoft) {
    var ApplicationInsights;
    (function (ApplicationInsights) {
...
/// <reference FullPath="../Contracts/Generated/MetricData.ts" />
/// <reference FullPath="./Common/DataSanitizer.ts" />
/// <reference FullPath="./Common/DataPoint.ts" />
var Microsoft;
(function (Microsoft) {
    var ApplicationInsights;
    (function (ApplicationInsights) {
...
/// <reference FullPath="EventData.ts" />
var AI;
(function (AI) {
    "use strict";
...
/// <reference FullPath="../Contracts/Generated/PageViewData.ts" />
/// <reference FullPath="./Common/DataSanitizer.ts"/>
var Microsoft;
(function (Microsoft) {
    var ApplicationInsights;
...
/// <reference FullPath="PageViewData.ts" />
var AI;
(function (AI) {
    "use strict";
...
/// <reference FullPath="../Contracts/Generated/PageViewPerfData.ts"/>
/// <reference FullPath="./Common/DataSanitizer.ts"/>
/// <reference FullPath="../Util.ts"/>
var Microsoft;
(function (Microsoft) {
...
/// <reference FullPath="sender.ts"/>
/// <reference FullPath="telemetry/trace.ts" />
/// <reference FullPath="telemetry/event.ts" />
/// <reference FullPath="telemetry/exception.ts" />
/// <reference FullPath="telemetry/metric.ts" />
/// <reference FullPath="telemetry/pageview.ts" />
/// <reference FullPath="telemetry/pageviewperformance.ts" />
/// <reference FullPath="./Util.ts"/>
/// <reference FullPath="./Contracts/Generated/SessionState.ts"/>
var Microsoft;
(function (Microsoft) {
...
/// <reference FullPath="../../Contracts/Generated/Data.ts"/>
var Microsoft;
(function (Microsoft) {
    var ApplicationInsights;
    (function (ApplicationInsights) {
...
/// <reference FullPath="../AppInsights.ts" />
var Microsoft;
(function (Microsoft) {
    var ApplicationInsights;
    (function (ApplicationInsights) {
...
/// <reference FullPath="Domain.ts" />
/// <reference FullPath="DataPointType.ts" />
/// <reference FullPath="DependencyKind.ts" />
/// <reference FullPath="DependencySourceType.ts" />
var AI;
(function (AI) {
    "use strict";
...
/// <reference FullPath="../Contracts/Generated/PageViewData.ts" />
/// <reference FullPath="./Common/DataSanitizer.ts"/>
/// <reference FullPath="../Contracts/Generated/RemoteDependencyData.ts"/>
var Microsoft;
(function (Microsoft) {
    var ApplicationInsights;
    (function (ApplicationInsights) {
...
/// <reference FullPath="telemetrycontext.ts" />
/// <reference FullPath="./Telemetry/Common/Data.ts"/>
/// <reference FullPath="./Util.ts"/>
/// <reference FullPath="./Contracts/Generated/SessionState.ts"/>
/// <reference FullPath="./Telemetry/PageViewManager.ts"/>
/// <reference FullPath="./Telemetry/PageVisitTimeManager.ts"/>
/// <reference FullPath="./Telemetry/RemoteDependencyData.ts"/>
/// <reference FullPath="./ajax/ajax.ts"/>
/// <reference FullPath="./DataLossAnalyzer.ts"/>
/// <reference FullPath="./SplitTest.ts"/>
var Microsoft;
(function (Microsoft) {
    var ApplicationInsights;
    (function (ApplicationInsights) {
...
/// <reference FullPath="Domain.ts" />
/// <reference FullPath="SessionState.ts" />
var AI;
(function (AI) {
    "use strict";
...
/// <reference FullPath="initialization.ts" />
var Microsoft;
(function (Microsoft) {
    var ApplicationInsights;
    (function (ApplicationInsights) {
